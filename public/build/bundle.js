    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(br, file$5, 68, 6, 1482);
    			attr_dev(div0, "class", "footer-title svelte-unzk1j");
    			add_location(div0, file$5, 66, 4, 1435);
    			attr_dev(i0, "class", "fab fa-linkedin-in");
    			add_location(i0, file$5, 79, 12, 1758);
    			attr_dev(a0, "href", "https://www.linkedin.com/in/charlierund/");
    			attr_dev(a0, "class", "link social-media-links svelte-unzk1j");
    			attr_dev(a0, "target", "_blank");
    			attr_dev(a0, "rel", "noopener");
    			add_location(a0, file$5, 74, 10, 1583);
    			attr_dev(li0, "class", "svelte-unzk1j");
    			add_location(li0, file$5, 73, 8, 1568);
    			attr_dev(i1, "class", "fab fa-twitter");
    			add_location(i1, file$5, 88, 12, 2010);
    			attr_dev(a1, "href", "https://twitter.com/charlie_baez");
    			attr_dev(a1, "class", "link social-media-links svelte-unzk1j");
    			attr_dev(a1, "target", "_blank");
    			attr_dev(a1, "rel", "noopener");
    			add_location(a1, file$5, 83, 10, 1843);
    			attr_dev(li1, "class", "svelte-unzk1j");
    			add_location(li1, file$5, 82, 8, 1828);
    			attr_dev(i2, "class", "fab fa-instagram");
    			add_location(i2, file$5, 97, 12, 2265);
    			attr_dev(a2, "href", "https://www.instagram.com/charliebaez85");
    			attr_dev(a2, "class", "link social-media-links svelte-unzk1j");
    			attr_dev(a2, "target", "_blank");
    			attr_dev(a2, "rel", "noopener");
    			add_location(a2, file$5, 92, 10, 2091);
    			attr_dev(li2, "class", "svelte-unzk1j");
    			add_location(li2, file$5, 91, 8, 2076);
    			attr_dev(ul, "class", "svelte-unzk1j");
    			add_location(ul, file$5, 72, 6, 1555);
    			attr_dev(div1, "class", "footer-social-links svelte-unzk1j");
    			add_location(div1, file$5, 71, 4, 1515);
    			attr_dev(div2, "class", "row footer-copy svelte-unzk1j");
    			add_location(div2, file$5, 65, 2, 1401);
    			attr_dev(div3, "class", "row");
    			add_location(div3, file$5, 103, 2, 2359);
    			attr_dev(div4, "class", "container svelte-unzk1j");
    			add_location(div4, file$5, 64, 0, 1375);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
