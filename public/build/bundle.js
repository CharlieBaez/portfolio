    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p0, file$3, 107, 8, 2346);
    			add_location(em, file$3, 109, 10, 2394);
    			attr_dev(p1, "class", "svelte-1fuaq60");
    			add_location(p1, file$3, 108, 8, 2380);
