    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p0, file$3, 113, 8, 2496);
    			add_location(em, file$3, 115, 10, 2544);
    			attr_dev(p1, "class", "svelte-1fuaq60");
    			add_location(p1, file$3, 114, 8, 2530);
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(br, file$5, 69, 6, 1500);
    			attr_dev(div0, "class", "footer-title svelte-1bx7gkp");
    			add_location(div0, file$5, 67, 4, 1453);
    			attr_dev(i0, "class", "fab fa-linkedin-in");
    			add_location(i0, file$5, 81, 12, 1797);
    			attr_dev(a0, "href", "https://www.linkedin.com/in/charlierund/");
    			attr_dev(a0, "class", "link social-media-links svelte-1bx7gkp");
    			attr_dev(a0, "target", "_blank");
    			attr_dev(a0, "rel", "noopener");
    			add_location(a0, file$5, 75, 10, 1601);
    			attr_dev(li0, "class", "svelte-1bx7gkp");
    			add_location(li0, file$5, 74, 8, 1586);
    			attr_dev(i1, "class", "fab fa-twitter");
    			add_location(i1, file$5, 91, 12, 2069);
    			attr_dev(a1, "href", "https://twitter.com/charlie_baez");
    			attr_dev(a1, "class", "link social-media-links svelte-1bx7gkp");
    			attr_dev(a1, "target", "_blank");
    			attr_dev(a1, "rel", "noopener");
    			add_location(a1, file$5, 85, 10, 1882);
    			attr_dev(li1, "class", "svelte-1bx7gkp");
    			add_location(li1, file$5, 84, 8, 1867);
    			attr_dev(i2, "class", "fab fa-instagram");
    			add_location(i2, file$5, 101, 12, 2346);
    			attr_dev(a2, "href", "https://www.instagram.com/charliebaez85");
    			attr_dev(a2, "class", "link social-media-links svelte-1bx7gkp");
    			attr_dev(a2, "target", "_blank");
    			attr_dev(a2, "rel", "noopener");
    			add_location(a2, file$5, 95, 10, 2150);
    			attr_dev(li2, "class", "svelte-1bx7gkp");
    			add_location(li2, file$5, 94, 8, 2135);
    			attr_dev(ul, "class", "svelte-1bx7gkp");
    			add_location(ul, file$5, 73, 6, 1573);
    			attr_dev(div1, "class", "footer-social-links svelte-1bx7gkp");
    			add_location(div1, file$5, 72, 4, 1533);
    			attr_dev(div2, "class", "row footer-copy svelte-1bx7gkp");
    			add_location(div2, file$5, 66, 2, 1419);
    			attr_dev(div3, "class", "row");
    			add_location(div3, file$5, 107, 2, 2440);
    			attr_dev(div4, "class", "container svelte-1bx7gkp");
    			add_location(div4, file$5, 65, 0, 1393);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
